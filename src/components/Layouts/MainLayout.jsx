...
const MainLayout = (props) => {
  ...
  return (
    <>
      {/* Backdrop muncul saat proses logout  */}
      <Backdrop
      ...
      >
        ...
        <div className="flex flex-1 flex-col bg-special-mainBg dark:bg-dark-bg dark:text-white">
          {/* navbar */}
          <header className="border border-b border-gray-05 px-6 py-7 dark:border-gray-600 flex justify-between items-center">
          ...
          {/* content */}
          <main className="flex-1 px-6 py-4 dark:bg-dark-bg">{children}</main>
        </div>
      </div>
    </>
  );
